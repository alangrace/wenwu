    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      <table class="GoodList">
        ...
        <tbody>
          ...
          <tr class="good">
            <td class="name First">
              <!-- <a target="_blank" :href="'https://localhost:3000/course/'+ornpmder.courseId"> -->
              <a
                target="_blank"
      ...
      <div class="Finish">
        ...
        <div class="Main fl">
          <div class="fl">
            <a :href="'/course/' + order.courseId">返回详情页</a>
          </div>
          <div class="fr">
            <p>
              共 <strong class="red">1</strong> 件商品，合计<span
...
export default {
  asyncData({ params, error }) {
    //根据页面写，因为是oid，所以是params.oid
    return ordersApi.getOrdersInfo(params.oid).then((response) => {
      return {
        //OrderController里 getOrderInfo的返回值是item
