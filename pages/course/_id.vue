        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt c-attr-undis">
              <span class="c-fff fsize14">品类： {{courseWebVo.teacherName}}&nbsp;&nbsp;&nbsp;</span>
            </section>
        ...
        <aside class="thr-attr-box">
          <ol class="thr-attr-ol">
            <li>
              <p>&nbsp;</p>
              <aside>
                <span class="c-fff f-fM">喜爱人数</span>
                <br>
            ...
            <li>
              <p>&nbsp;</p>
              <aside>
                <span class="c-fff f-fM">热门度</span>
                <br>
            ...
            <div class="i-box">
              <div>
                <section id="c-i-tabTitle" class="c-infor-tabTitle c-tab-title">
                  <a name="c-i" class="current" title="课程详情">鉴定结论</a>
                </section>
              </div>
          ...
          <div class="i-box">
            <div>
              <section class="c-infor-tabTitle c-tab-title">
                <a title href="javascript:void(0)">鉴定人</a>
              </section>
                  ...
                  <li>
                    <div class="u-face">
                      <a href="#">
                        ...
                        <img src="~/assets/img/藏品鉴定.png" width="50" height="50" alt>
                      </a>
                    </div>
                    <section class="hLh30 txtOf">
                      <a class="c-333 fsize16 fl" href="#">张工</a>
                    </section>
                    <section class="hLh20 txtOf">
                      <span class="c-999">高级文物鉴定师</span>
                    </section>
                  </li>
                </ul>
              </section>
